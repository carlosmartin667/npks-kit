            ...
            <Row>
              <Col md="6" sm="12" className="mb-1">
                ...
                <Input
                  ...
                  name="name"
                  id="nameMulti"
                  placeholder="Nivel de compactación"
                />
              </Col>
              <Col md="6" sm="12" className="mb-1">
                ...
                <Input
                  ...
                  name="lastname"
                  id="lastNameMulti"
                  placeholder="Limitación por anegamiento"
                />
              </Col>
              <Col md="6" sm="12" className="mb-1">
                <Label className="form-label" for="cityMulti">
                  Profundidad enraizable (cm)
                </Label>
                <Input
                  type="text"
                  name="city"
                  id="cityMulti"
                  placeholder="Profundidad enraizable"
                />
              </Col>
              <Col md="6" sm="12" className="mb-1">
                <Label className="form-label" for="cityMulti">
                ...
                <Input
                  ...
                  name="city"
                  id="cityMulti"
                  placeholder="Análisis de suelo"
                />
              </Col>

              <span className="mb-5"></span>

              <CardSubtitle className="fs-4 mb-2">Estrato 1</CardSubtitle>

              <Col md="4" sm="12">
                <Label className="mt-1">Profundidad (cm)</Label>
                <Input placeholder="Profundidad (cm)" />

                <Label className="mt-1">S-SO4</Label>
              ...
              <Col md="4" sm="12">
                <Label className="mt-1">Densidad del suelo</Label>
                <Input placeholder="Densidad del suelo" />

                <Label className="mt-1">N total</Label>
                <Input placeholder="N total" />

                <Label className="mt-1">CE</Label>
                <Input placeholder="CE" />

                <Label className="mt-1">Cai</Label>
                <Input placeholder="Cai" />

                <Label className="mt-1">Ki</Label>
                <Input placeholder="Ki" />
              </Col>

              <Col md="4" sm="12">
                <Label className="mt-1">N-NO3</Label>
                <Input placeholder="N-NO3" />

                <Label className="mt-1">Fmin</Label>
                <Input placeholder="Fmin" />

                <Label className="mt-1">PH</Label>
                <Input placeholder="PH" />

                <Label className="mt-1">Mgi</Label>
                <Input placeholder="Mgi" />

                <Label className="mt-1">Agregar estrato +</Label>
                <Input placeholder="Agregar estrato +" />
              </Col>
            </Row>
          </Form>
        </CardBody>
